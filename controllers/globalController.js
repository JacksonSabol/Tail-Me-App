...
module.exports = {
    ...
    createInvitation: function (req, res) {
        ...
        function sendSMSowner (dbModel, walkerName) {
            ...
            var invitation = `Hi ${ownerName}, ${walkerName} has invited you to join TailMe and setup all the info about your dog. http://localhost:3000/owner/signup/${urlCode1}/${urlCode2}`
