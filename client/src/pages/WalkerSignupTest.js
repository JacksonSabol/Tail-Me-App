...
class WalkerSignup extends Component {
    ...
    handleFormSubmit = event => {
        ...
        if (!this.state.email || !this.state.password) {
            ...
            // Make POST request to the Auth route with the user's email and password; clear `this.state.email` and `this.state.password`, clearing the inputs
            axios.post('/walker/signup', {
